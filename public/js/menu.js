...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(199);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        ...
        showDetalle: function showDetalle(producto) {
            this.showDetail = [];
        ...
        cancelarNuevoMenu: function cancelarNuevoMenu() {
        ...
        valorProducto: function valorProducto(producto, id) {
            ...
            if (cantidad == 0 || cantidad == '') {
                ...
                var index = this.productosDetalle.findIndex(function (x) {
                    return x.id == producto.id;
                }); // verificar si el producto ya está en el array de productosDetalle
                if (index == -1) {
                    ...
                    this.total = this.productosDetalle.reduce(function (acc, val, i, productosDetalle) {
                        //con la funcion reduce sumamos todos y cada unos de los objetos dentro del array de objetos productosDetalle, devolviendolo en la variable this.total
        ...
        deleteProductoDetalle: function deleteProductoDetalle(producto) {
            var index = this.productosDetalle.findIndex(function (x) {
                return x.id == producto.id;
            }); //calcular en que posicion (index del array) está el elemento con el ID dado 
            ...
            var indexValores = this.totales.findIndex(function (x) {
                return x.id == producto.id;
            }); //calcular en que posicion (index del array) está el elemento con el ID dado
        ...
        crearMenu: function crearMenu() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('menus', {
                total: this.total,
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9), __webpack_require__(197).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9), __webpack_require__(138)))
